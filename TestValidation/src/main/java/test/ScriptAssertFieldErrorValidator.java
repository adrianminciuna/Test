 ...
 *
 */
public class ScriptAssertFieldErrorValidator
		implements ConstraintValidator<ScriptAssertFieldError, Object> {
  ...
  private static final String TRUE_OR_FALSE_EXCEPTION = "script must return true or false";
	...
	public boolean isValid(Object value, ConstraintValidatorContext context) {
		...
		try {
			 ...
			 map.put(alias, value);
			evaluationResult = scriptEvaluator.evaluate( script, map );
		}
		catch ( ScriptException e ) {
